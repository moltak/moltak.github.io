...
# 두서없이 적어보는 ...
[AMD 아치리눅스 셋업](/blog/09-amd-archilinux-setup)에 보면 나는 최근 엄청난 가성비 랩탑을 구매해서 아치리눅스를 세팅했다. 여러가지 삽질이 있긴 했지만. 그건 나중에 또 캡쳐서하면서 적도록 하고 (일단 목차만 만들어둠) 지금 상황을 보자면 참 좋다. 아래 내가 세팅한 것 들을 좀 나열해본다.
