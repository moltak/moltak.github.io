...
## 카카오톡
Archi는 AUR(arch user repository)가 정말 좋은데, 여기에 누군가가 카톡도 올려뒀다. 그거 설치하면 카톡이 정말 잘 동작한다. 또한 [wine11](https://news.hada.io/topic?id=27826)에선 카톡이 놀라울만큼 잘 동작하는데, 심지어 파일공유도 너무 잘되고 Windows에서 동작하는거 같은 쾌적함을 느낄 수 있다.
